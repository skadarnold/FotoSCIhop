...
#define INTERFACE_PROPERTIES "Proprietà"
...
#define INTERFACE_ENDOFFILESSTR "Non ci sono altri file successivi. La ricerca proseguirà dal primo file della cartella."
...
#define INTERFACE_LICENSE "Questo programma è open source (licenza GNU GPL), può essere distribuito e modificato purché resti open source.\n"
...
#define INTERFACE_NOTICE "L'autore declina da ogni responsabilità circa eventuali danni causati dal suo utilizzo.\n\nSCI (Sierra Creative Interpreter) è un marchio registrato di Sierra On-Line che ne detiene i diritti.  "                
...
#define WARN_DIFFERENTPAL "L'immagine che si sta importando ha una tavolozza di colori differente dall'originale, e si cercherà di adattarla con un operazione non raccomandabile. Procedere?"
#define ERR_DIFFERENTPALBIS "L'immagine che si sta importando ha una tavolozza di colori differente dall'originale, modificare l'immagine da importare in un programma di disegno affinché abbia gli stessi colori."
#define ERR_REMAPNOTIMPLEMENTEDYET "Remapping non ancora implementato!!!!"                
                
#define ERR_WRONGHEADER	"Il formato dell'intestazione del file non è corretto o supportato."
...
#define ERR_CANTLOADPALETTE "La tavola dei colori non può essere caricata."
#define ERR_CANTEXPORTPALETTE "La tavola dei colori non può essere salvata su disco."
...
#define WARN_OVERWRITE "Salvando le modifiche il file originale verrà modificato irreversibilmente. Continuare?"
...
#define WARN_MISSINGPALETTE "Non c'è una tavola dei colori in questo file, quindi le immagini non saranno visualizzate correttamente. Caricare un file di colori esterno per risolvere il problema."
